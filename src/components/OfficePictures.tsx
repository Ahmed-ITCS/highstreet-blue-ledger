  ...
  return (
    <section className="py-16 md:py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        <AnimatedElement type="fade-in" delay={0.2} className="text-center mb-16">
        ...
        <div className="lg:hidden">
          <AnimatedElement type="slide-in-bottom" delay={0.3}>
        ...
        <AnimatedElement type="slide-in-bottom" delay={0.6} className="mt-12 text-center">
